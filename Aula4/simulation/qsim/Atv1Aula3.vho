...
-- Dado[0]	=>  Location: PIN_N21,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Dado[1]	=>  Location: PIN_P17,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Dado[2]	=>  Location: PIN_P22,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Dado[3]	=>  Location: PIN_N16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Dado[4]	=>  Location: PIN_M16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Dado[5]	=>  Location: PIN_M22,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Dado[6]	=>  Location: PIN_P16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Dado[7]	=>  Location: PIN_L22,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Endereco[2]	=>  Location: PIN_M18,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Endereco[0]	=>  Location: PIN_N19,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Endereco[1]	=>  Location: PIN_N20,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \ALT_INV_memROM~4_combout\ : std_logic;
...
\ALT_INV_memROM~4_combout\ <= NOT \memROM~4_combout\;
...
-- Equation(s):
-- \memROM~0_combout\ = ( \Endereco[0]~input_o\ & ( \Endereco[2]~input_o\ & ( \Endereco[1]~input_o\ ) ) ) # ( !\Endereco[0]~input_o\ & ( \Endereco[2]~input_o\ ) ) # ( \Endereco[0]~input_o\ & ( !\Endereco[2]~input_o\ & ( !\Endereco[1]~input_o\ ) ) ) # ( 
-- !\Endereco[0]~input_o\ & ( !\Endereco[2]~input_o\ & ( \Endereco[1]~input_o\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011001100110011110011001100110011111111111111110011001100110011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \memROM~1_combout\ = ( \Endereco[0]~input_o\ & ( \Endereco[2]~input_o\ & ( !\Endereco[1]~input_o\ ) ) ) # ( \Endereco[0]~input_o\ & ( !\Endereco[2]~input_o\ ) ) # ( !\Endereco[0]~input_o\ & ( !\Endereco[2]~input_o\ ) )
...
-- Equation(s):
-- \memROM~2_combout\ = ( \Endereco[0]~input_o\ & ( \Endereco[2]~input_o\ ) ) # ( !\Endereco[0]~input_o\ & ( \Endereco[2]~input_o\ ) ) # ( \Endereco[0]~input_o\ & ( !\Endereco[2]~input_o\ ) )
...
-- Equation(s):
-- \memROM~3_combout\ = ( \Endereco[0]~input_o\ & ( !\Endereco[2]~input_o\ ) )
...
-- Equation(s):
-- \memROM~4_combout\ = ( !\Endereco[0]~input_o\ & ( \Endereco[2]~input_o\ ) ) # ( \Endereco[0]~input_o\ & ( !\Endereco[2]~input_o\ & ( !\Endereco[1]~input_o\ ) ) ) # ( !\Endereco[0]~input_o\ & ( !\Endereco[2]~input_o\ & ( \Endereco[1]~input_o\ ) ) )
...
-- Equation(s):
-- \memROM~5_combout\ = ( !\Endereco[0]~input_o\ & ( \Endereco[2]~input_o\ ) )
